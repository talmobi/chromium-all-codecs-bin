...
test.skip( '.mp4 | H.265/HEVC Main@L3.1 | AAC lc', async function ( t ) {
  const page = await context.newPage()
...
test.skip( '.mp4 | H.265/HEVC Main | (no sound)', async function ( t ) {
  const page = await context.newPage()
...
test.skip( '.3gp | MPEG-4 Visual Simple@L1 | AAC lc', async function ( t ) {
  const page = await context.newPage()
